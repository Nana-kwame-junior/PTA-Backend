...
def match_parent_to_student(parent: Parent, student: Student, entered_ward_name: str, entered_ward_form: str, entered_index_number: str | None = None) -> int:
    if entered_index_number and entered_index_number == student.index_number:
        return 100
    score = 0
    # Fuzzy name match
...
def find_matches(parent: Parent, db: Session, entered_ward_name: str, entered_ward_form: str, entered_index_number: str = None):
    ...
    for student in students:
        ...
        score = match_parent_to_student(parent, student, entered_ward_name, entered_ward_form, entered_index_number)
        if score >= 40:
